  ...
  return (
    <div ref={ref} className={cn("relative", className)}>
      <button
        ...
        className="font-roboto-mono hover:bg-background-primary-hoverfocus:outline-none relative z-10 flex w-full items-center justify-between rounded bg-transparent px-5 py-2.5 text-center font-medium text-white max-sm:px-3"
        type="button"
        disabled={disabled}
        onClick={() => {
