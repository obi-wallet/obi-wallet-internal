...
export function keygenerator_handleIncoming(
  a: number,
  b: number,
  c: number,
): void;
...
export function keyrefresh_new(
  a: number,
  b: number,
  c: number,
  d: number,
...
export function keyrefresh_handleIncoming(
  a: number,
  b: number,
  c: number,
): void;
...
export function simulationsigner_completedOfflineStage(
  a: number,
  b: number,
): void;
...
export function rustsecp256k1_v0_4_1_default_illegal_callback_fn(
  a: number,
  b: number,
): void;
export function rustsecp256k1_v0_4_1_default_error_callback_fn(
  a: number,
  b: number,
): void;
...
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h854126ca0f210dda(
  a: number,
  b: number,
): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h13d5d7815c89d609(
  a: number,
  b: number,
  c: number,
): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h59685417c1e36bab(
  a: number,
  b: number,
  c: number,
): void;
...
export function wasm_bindgen__convert__closures__invoke2_mut__ha63aa4c8b1dd3ece(
  a: number,
  b: number,
  c: number,
  d: number,
