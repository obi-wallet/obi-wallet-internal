...
function __wbg_adapter_48(arg0, arg1) {
    wasm.wasm_bindgen__convert__closures__invoke0_mut__he6ba9d45428c4847(arg0, arg1);
}

function __wbg_adapter_51(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures__invoke1_mut__h82ff6324a435aa73(arg0, arg1, addHeapObject(arg2));
}
...
* @returns {any}
*/
export function keyRefreshSimulated(parameters, key_refresh_items) {
    try {
...
* @returns {any}
*/
export function keygen(options, participants) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {any}
*/
export function sign(options, participants, signing_key, message) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {any}
*/
export function generateKeypair(pattern) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {any}
*/
export function createMeeting(options, identifiers, initiator, data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {any}
*/
export function joinMeeting(options, meeting_id, user_id) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {any}
*/
export function keygenSimulated(parameters) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {Array<any>}
*/
export function signingOfflineStageSimulated(local_keys) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {Array<any>}
*/
export function createSigners(completed_offline_stages) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_simulationsigner_new = function(arg0) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('mpc_bindings_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
