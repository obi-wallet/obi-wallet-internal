...
export type TelegramKeyConfirmScreenProps = NativeStackScreenProps<
  KeyStackParamList,
  KeyRoute.TelegramKeyConfirm
>;

export const TelegramKeyConfirmScreen = observer<TelegramKeyConfirmScreenProps>(
  function TelegramKeyConfirmScreen({ route }) {
...
export interface TelegramKeyConfirmProps {
  draftId: string;
  flow: KeyFlow;
  demoMode: boolean;
  chatID: string;
...
export const TelegramKeyConfirm = observer<TelegramKeyConfirmProps>(
  function TelegramKeyConfirm({
    draftId,
    // flow,
    demoMode,
    chatID,
