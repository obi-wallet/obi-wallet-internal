module.exports = {
  ...
  transformIgnorePatterns: [
    "node_modules/(?!(@fortawesome|@react-native|@react-navigation|react-native|react-native-code-push|react-native-country-picker-modal|react-native-device-info|react-native-dropdown-picker|react-native-haptic-feedback|react-native-keychain|react-native-iphone-x-helper|react-native-fontawesome|react-native-keyboard-aware-scroll-view|react-native-safe-area-context)/)",
  ],
